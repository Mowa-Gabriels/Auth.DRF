...
from .serializers import (TeacherRegisterSerializer, StudentRegisterSerializer, VerifyEmailSerializer,
...
class TeacherRegisterView(generics.GenericAPIView):
    ...
    def post(self, request):
        ...
        relativeLink = reverse('verify-email-teacher')
...
class TeacherVerifyEmailView(views.APIView):
...
class StudentVerifyEmailView(views.APIView):
    serializer_class = VerifyEmailSerializer
